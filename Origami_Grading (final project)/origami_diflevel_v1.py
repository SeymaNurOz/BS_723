...
# yourpath = r'C:\Users\seyma\Desktop\BS723 ML\2022-06-30\difficulties\na'
...
#         img_resized.save(r"C:\Users\seyma\Desktop\BS723 ML\2022-06-30\resized_ph\no-origami"+"\RESIZED"+name)

"""SPLITING DATA AS TRAIN, VALIDATION AND TEST"""
"""oranlar nasıl olsunnn,test olsun mu"""

# splitfolders.ratio('resized_ph', output="splitted_ph4", seed=7, ratio=(.7, 0.2,0.1)) 
...
train_dir = r"C:\Users\seyma\Desktop\BS723 ML\final-revised\splitted_ph4\train"
val_dir = r"C:\Users\seyma\Desktop\BS723 ML\final-revised\splitted_ph4\val"
test_dir = r"C:\Users\seyma\Desktop\BS723 ML\final-revised\splitted_ph4\test"
...
if mode == "train":
    ...
    model.save_weights('model_ph1_100.h5')
    plot_model_history(model_info)

# mode="train2"

if mode == "train2":
    model.load_weights('model_ph1_40.h5')
    model.compile(loss='categorical_crossentropy',optimizer=Adam(lr=0.0001, decay=1e-6),metrics=['accuracy'])
    model_info = model.fit_generator(
            train_generator,
            steps_per_epoch=num_train // batch_size,
...
if mode=="predict":
    ...
    origami_dict = {0: "easy", 1: "medium", 2: "hard"}
    ...
    for i in range(len(X_train)):
        ...
        # plt.savefig( r"C:\Users\seyma\Desktop\BS723 ML\final-revised\images_ph2\\"+ str(i)+ '.png', dpi=1000, bbox_inches = 'tight')
        # break
    # print(Y_pred)
    # print(Y_real)
